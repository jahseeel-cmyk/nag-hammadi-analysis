...
- **Full-text search does not work on Coptic.** `Grep` returns empty for every Coptic Unicode query in this workspace — the index does not handle the Coptic block. Do not retry it.
